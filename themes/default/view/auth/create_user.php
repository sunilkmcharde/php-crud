                        ...
                        <div class="col-md-5">
                            <div class="form-group">
                                ...
                                <div class="controls">
                                    ...
                                    echo form_input('first_name', $first_name, 'class="form-control" id="first_name" required="required" pattern=".{3,10}"'); ?>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="controls">
                                    ...
                                    echo form_input('phone', $phone, 'class="form-control" id="phone" required="required"onkeypress="return IsNumeric(event)" ondrop="return 
