...
| Database Type
| -------------------------------------------------------------------------
| If set to TRUE, Crud Auth will use MongoDB as its database backend.
|
...
|
*/
$config['collections']['users']          = 'crud_users';
$config['collections']['groups']         = 'crud_groups';
$config['collections']['login_attempts'] = 'crud_login_attempts';
...
*/
$config['tables']['users']           = 'crud_users';
$config['tables']['groups']          = 'crud_groups';
$config['tables']['users_groups']    = '';
$config['tables']['login_attempts']  = 'crud_login_attempts';
 ...
 */
$config['site_title']                 = "PHP CRUD ADMIN Manager";       // Site Title, example.com This is not more functional
$config['admin_email']                = "contact@phpcrud.com"; // Admin Email, admin@example.com This is not more functional
...
/* End of file crud_auth.php */
/* Location: ./application/config/crud_auth.php */
